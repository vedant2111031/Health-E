...
// const Dashbord = () => {
//   const { data, loading, error, fetchData } = useFetchData(`${BASE_URL}/doctors/profile/me`
//   );
...
//             {/* Hamburger + Info Heading */}
//             <div className="flex items-center gap-3 lg:col-span-3 mb-6">
//               <Tabs tab={tab} setTab={setTab} />
